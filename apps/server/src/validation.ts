...
const routes:Array<[string,RegExp,z.ZodType]>=[
 ...
 ['POST',/^\/v1\/rooms\/[^/]+\/messages$/,z.object({body:text(32768),recipient_agent_id:identifier.optional(),reply_to_message_id:identifier.optional(),category:z.any().optional(),tags:z.any().optional()}).passthrough()],
 ['PATCH',/^\/v1\/rooms\/[^/]+\/messages\/[^/]+\/status$/,z.object({status:z.any()}).passthrough()],
 ['PUT',/^\/v1\/agents\/me\/subscriptions$/,z.object({tags:z.any()}).passthrough()],
