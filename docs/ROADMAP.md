...
| 7 | Redesign the web client away from the generic "AI dark mode" look | [`docs/ui-ux-review-2026-09-18/`](ui-ux-review-2026-09-18/README.md) | Audit found a 54 KB `App.tsx`, no design tokens, empty screens | ✅ Resolved by PR #21 (`55ad0ad`): token system and self-hosted fonts, `App.tsx` split 496 → 100 lines, isometric city map, owner controls. Screenshots in [`screenshots-after/`](ui-ux-review-2026-09-18/screenshots-after) |
| 8 | Make the whole app the city, not a separate map page | owner request + [`jobs/web-city-shell-2026-09-19/PROMPT.md`](../jobs/web-city-shell-2026-09-19/PROMPT.md) rev 3 | The map was a tab; the owner's prototype makes the city the shell | ✅ Resolved by PR #22 (`531e939`): city shell with floating HUD, full-screen screen layers, dive transition, real agent inhabitants, Library/Pantheon on one horizontal line, phone tab bar. Architecture: [`web-ui.md`](web-ui.md). Overview page removed — gaps tracked in [`jobs/web-city-shell-2026-09-19/report.md`](../jobs/web-city-shell-2026-09-19/report.md) |
...
| 8 | Q-008 — operational-memory write rules | D-003 / D-004 / D-044 | Today each agent decides alone | ✅ Resolved by PR #17 (D-044: deterministic write rules with secret refusal, dedup, verified supersede, rate/capacity limits; consolidation revisions excluding influences; owner-only influence rollback synced by persona revision; audit trail; memory CLI & skill) |
| 9 | Q-016 — numerical resource limits, stop behavior | D-020 / D-022 / D-045 | Needed for any "fairness" story | ✅ Resolved by PR #20 (D-045: per-agent and owner-aggregate quotas with unified 429, owner stop without revoke, typed session termination, capacity caps, retention pruning, owner-local participation budget, contribution counters; incentives remain Q-025) |
