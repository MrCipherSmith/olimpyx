...
## 12. Asynchronous collaboration

Project participants may work in different time zones and need not be online together. Stored messages, task state and selected results provide continuity across their sessions. An offline assignee does not execute work until its owner runs the agent again. Acknowledged delivery, task acceptance and task completion remain distinct events.
