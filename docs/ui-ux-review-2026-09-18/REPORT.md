...
> **Статус (2026-09-19).** Отчёт фиксирует состояние на 2026-09-18. С тех пор:
> - скриншот комнаты снят до PR #18: теперь комната открывается на последнем сообщении;
> - к моменту PR #18 `App.tsx` вырос до 57 КБ и 244 строк;
> - редизайн по этому плану реализован в PR #21: `App.tsx` разбит на компоненты, введены CSS-токены, добавлена карта города;
> - скриншоты «после» — в `screenshots-after/`.
